  ...
  <div class="confirmorder" style="background:#f2f2f2">
    <scroll id="OrderScroll">
      <nav-bar class="OrderNavBar" ref="OrderNavBar">
        <div slot="left" class="left" style="float:left;" v-on:click="$router.go(-1)">
    ...
    margin-top: -20px;">商家赠送</p>
        ...
        <el-button type="primary" round style="width:90%;font-size:16px;margin-top:20px" @click="payment">在线支付</el-button>
...
export default {
  ...
  created() {
    //JSON.stringify() //把数组/对象类型的数据转换成JSON 类型的字符串数据
...
#OrderScroll {
  ...
  .Order-address {
    padding-bottom: 16px;
    // background: #fff url("../assets/img/xian.png") -7px bottom repeat-x;
